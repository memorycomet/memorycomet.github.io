...
function loadQuestion(index) {
  ...
  explanationContainer.textContent = explanation; // Set the explanation content
...
function displayScore() {
  ...
  scoreElement.textContent =
    ...
    ' / ' +
    (totalQuestionsAttempted < 10 ? '0' + totalQuestionsAttempted : totalQuestionsAttempted);
}
...
function loadNextQuestion() {
  ...
  if (currentQuestionIndex < questions.length) {
    ...
    refreshButton.style.backgroundColor = '#ff7f00';
    ...
    resultContainer.innerHTML =
      'Your Score: ' +
      score +
      '<br>Questions Attempted: ' +
      totalQuestionsAttempted +
      '<br>Skipped Questions: ' +
      skippedQuestions;
  }
}
