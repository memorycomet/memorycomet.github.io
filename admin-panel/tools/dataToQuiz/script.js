...
function updatePreview(value) {
    ...
    <div class="quiz-question">
        <h3><span style="color:grey">Question </span>${index + 1}:</h3>
        ...
        <p class="quiz-explanation"><strong style="color:grey">Explanation:</strong> ${poll.explanation !== null && poll.explanation !== undefined ? poll.explanation : '<i style="color:grey">No explanation added </i>'}</p>
...
async function uploadQuestions() {
    ...
    try {
        ...
        alert('Questions sent to Telegram successfully!');
    } catch (error) {
